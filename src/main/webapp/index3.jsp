...
<head>
	...
	<link rel="apple-touch-icon" sizes="57x57" href="./resources/./resources/img/favicons/apple-touch-icon-57x57.png">
	<link rel="apple-touch-icon" sizes="60x60" href="./resources/./resources/img/favicons/apple-touch-icon-60x60.png">
	<link rel="icon" type="image/png" href="./resources/./resources/img/favicons/favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="image/png" href="./resources/./resources/img/favicons/favicon-16x16.png" sizes="16x16">
	<link rel="manifest" href="./resources/./resources/img/favicons/manifest.json">
	<link rel="shortcut icon" href="./resources/./resources/img/favicons/favicon.ico">
	<meta name="msapplication-TileColor" content="#00a8ff">
	<meta name="msapplication-config" content="./resources/./resources/img/favicons/browserconfig.xml">
	...
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="./resources/img/logo.png" data-active-url="./resources/img/logo-active.png" alt=""></a>
			</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="team text-center">
						<div class="cover" style="background:url('./resources/img/team/team-cover1.jpg'); background-size:cover;">
				...
				<div class="col-md-4">
					<div class="team text-center">
						<div class="cover" style="background:url('./resources/img/team/team-cover2.jpg'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">$69.00</h3>
								<h5 class="light light-white">1 - 5 sessions / month</h5>
							</div>
				...
				<div class="col-md-4">
					<div class="team text-center">
						<div class="cover" style="background:url('./resources/img/team/team-cover3.jpg'); background-size:cover;">
							<div class="overlay text-center">
								<h3 class="white">$69.00</h3>
								<h5 class="light light-white">1 - 5 sessions / month</h5>
							</div>
